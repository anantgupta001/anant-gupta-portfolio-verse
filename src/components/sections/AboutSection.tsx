...
export const AboutSection = () => (
  ...
  >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-7xl mx-auto">
      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-4 sm:p-6 flex flex-col items-start min-h-[200px] sm:min-h-[260px] z-10 border border-border-light dark:border-border-dark transition-transform duration-200 hover:scale-105 hover:shadow-2xl col-span-1 sm:col-span-2 lg:col-span-1">
        ...
        <h3 className="text-base sm:text-lg font-bold mb-2 text-[color:var(--accent)]">Open Source Contribution</h3>
        <p className="text-sm sm:text-base text-gray-700 dark:text-gray-200 mb-2">Contributed to FFCS on the Go, an open-source platform used by over 120,000 VIT students each semester to simplify and accelerate the traditionally hectic course registration process.</p>
      ...
      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-4 sm:p-6 flex flex-col items-start min-h-[200px] sm:min-h-[260px] z-10 border border-border-light dark:border-border-dark transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
        ...
        <h3 className="text-base sm:text-lg font-bold mb-2 text-[color:var(--accent)]">Full Stack Engineering</h3>
        <p className="text-sm sm:text-base text-gray-700 dark:text-gray-200 mb-2">Built StayHub, a dynamic accommodation platform with secure authentication, integrated location services using Mapbox, and responsive UI.</p>
      ...
      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-4 sm:p-6 flex flex-col items-start min-h-[200px] sm:min-h-[260px] z-10 border border-border-light dark:border-border-dark transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
        ...
        <h3 className="text-base sm:text-lg font-bold mb-2 text-[color:var(--accent)]">Technical Leadership</h3>
        <p className="text-sm sm:text-base text-gray-700 dark:text-gray-200 mb-2">Led a 5-member team to develop FoodApe, a food ordering app used by 30,000+ VIT-AP students.</p>
      ...
      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-4 sm:p-6 flex flex-col items-start min-h-[200px] sm:min-h-[260px] z-10 border border-border-light dark:border-border-dark transition-transform duration-200 hover:scale-105 hover:shadow-2xl col-span-1 sm:col-span-2 lg:col-span-1">
        ...
        <h3 className="text-base sm:text-lg font-bold mb-2 text-[color:var(--accent)]">AI/ML</h3>
        <p className="text-sm sm:text-base text-gray-700 dark:text-gray-200 mb-2">Developed an Age Detection Model, a CNN-based ensemble system designed to predict age from facial images with high accuracy.</p>
