        ...
        {skillCategories.map((category, index) => {
          ...
          return (
            <div
              key={index}
              ref={elementRef}
              className={`bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark transition-all duration-700 ease-out transform ${
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-heading-light dark:text-heading-dark">{category.title}</h3>
              </div>
