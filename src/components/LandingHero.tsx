  ...
  return (
    <section className="w-full min-h-[80vh] flex flex-col justify-between bg-background-light dark:bg-background-dark px-4 pb-0 relative overflow-hidden">
      <div className="w-full max-w-xl pl-4 md:pl-12 flex flex-col items-start gap-6 text-left pt-24 relative z-10">
        <h1 className="text-4xl md:text-5xl font-bold font-sans mb-0 text-heading-light dark:text-heading-dark">Hoii, I'm</h1>
        <div className="text-5xl md:text-6xl font-bold font-sans mb-2 bg-gradient-to-r from-[#2563eb] to-[#60a5fa] dark:from-[#60a5fa] dark:to-[#3b82f6] bg-clip-text text-transparent">Anant Gupta</div>
        <p className="text-lg md:text-xl text-gray-700 dark:text-gray-200 font-sans mb-4">Turning ideas into impactful code<br />with clarity and precision.</p>
